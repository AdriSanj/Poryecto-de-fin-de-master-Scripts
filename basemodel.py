#Same file as basemodel.py but with a few necessary changes for run Larvalfish_ieo
        ...
        for i in range(self.expected_steps_calculation):
            try:
                ...
                if self.num_elements_active() > 0:
                    ...
                    #if (self.get_config('vertical_mixing:TSprofiles') is True                        # MODIFICACION AQUI HASTA 2500
